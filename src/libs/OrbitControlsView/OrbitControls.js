...
export class OrbitControls extends EventDispatcher {
    constructor(object, ref) {
        ...
        this.update = (() => {
            ...
            // console.log(quat.clone() instanceof Quaternion)
            ...
            return () => {
                ...
                // console.log('as', position, this.target, offset)
                ...
                // console.log(this.panOffset, this.target)
        ...
        this.panLeft = (() => {
            ...
            return (distance, objectMatrix) => {
                ...
                // console.log('left', v, objectMatrix, this.panOffset)
            };
        })();
        this.panUp = (() => {
            const v = new Vector3();
            return (distance, objectMatrix) => {
                ...
                v.multiplyScalar(distance);
                this.panOffset.add(v);
                // console.log('up', v, objectMatrix, this.panOffset)
            };
        })();
